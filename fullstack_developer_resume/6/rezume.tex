...
\section{about me}
\small{
Highly skilled Fullstack Developer with over 10 years of experience in developing dynamic web applications. Expert in creating efficient and scalable code using \textbf{PHP} frameworks such as \textbf{Laravel} for backend and React or Next for frontend with strong problem-solving abilities and a passion for delivering high-quality software solutions. Excellent team player with effective communication skills.
}
%--------------------------------------------
