...
\resumeHeadingListStart{}
  ...
  {Faico Holding - Steel Factory}{}
    \resumeItemListStart{}
      \resumeItem{Designed and developed dynamic and responsive websites using \textbf{Next}}
  ...
  {Maghzafzar - Online Chess Game Platform}{}
    \resumeItemListStart{}
    	\resumeItem{Developed and maintained complex web applications using \textbf{React} and \textbf{Next}}
