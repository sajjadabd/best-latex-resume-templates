...
\section{about me}
\small{
Highly skilled PHP Developer with over 7 years of experience in developing dynamic web applications. Expert in creating efficient and scalable code using \textbf{PHP} frameworks such as \textbf{Laravel} with strong problem-solving abilities and a passion for delivering high-quality software solutions. Excellent team player with effective communication skills.
}
%--------------------------------------------
