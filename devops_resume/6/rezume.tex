...
\newcommand{\resumeSectionType}[3]{
  \item\begin{tabular*}{0.96\textwidth}[t]{
    p{0.21\linewidth}p{0.02\linewidth}p{0.81\linewidth}
  }
    \textbf{#1} & #2 & #3
...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  \textbf{\Huge Sajjad Abdollahi \vspace{2pt}} & % row = 1, col = 1
  \href{https://github.com/sajjadabd}{\uline{https://github.com/sajjadabd}}  \\ % row = 1, col = 2
  ...
  {Devops Engineer} &
  Email: \href{mailto:mynameissajjad@gmail.com}{\uline{mynameissajjad@gmail.com}}  % row = 2, col = 2
   \\ 
  % row = 2, col = 2
...
\section{about me}
\small{
A highly skilled and motivated DevOps Engineer with 3 years of experience in designing, implementing, and optimizing CI/CD pipelines, automating infrastructure, and ensuring seamless application deployments. Seeking to leverage my technical expertise and problem-solving skills to contribute to the success of a dynamic and innovative organization.
}
%--------------------------------------------
...
\section{Technical Skills}
  \resumeHeadingListStart{}
    \resumeSectionType{CI/CD}{:}{Jenkins, GitLab CI, HTML, CSS}
    \resumeSectionType{Cloud Platforms}{:}{AWS, GCP}
    %\resumeSectionType{Libraries}{:}{Material, Redux, React Router}
    %\resumeSectionType{Databases}{:}{MySQL, Sqlite, PostgreSQL, MongoDB}
    \resumeSectionType{Containerization}{:}{Docker, Docker Compose, Kubernetes, Docker, CI/CD Pipelines}
    \resumeSectionType{Infrastructure as Code}{:}{Terraform, Ansible } 
    \resumeSectionType{Monitoring}{:}{Prometheus, Splunk}
    \resumeSectionType{Web Servers}{:}{Nginx}
    \resumeSectionType{DBMS}{:}{MySQL, PostgreSQL, MongoDB}
...
\section{Experience}
\resumeHeadingListStart{}
  \resumeQuadHeading{Devops Engineer}{May 2019 -- Present}
  {Faico Holding - Steel Factory}{}
    \resumeItemListStart{}
      \resumeItem{managing cloud infrastructure and leveraging IaC tools like Terraform and Ansible.}
      \resumeItem{Experienced in designing and implementing \textbf{CI/CD pipelines} }
      \resumeItem{experience with containerization technologies, including Docker and orchestration platforms like Kubernetes.}
      \resumeItem{automating routine tasks with scripting languages (e.g., Python, Bash) and configuration management tools}
      \resumeItem{Skilled in monitoring and logging tools like Prometheus, Grafana, and ELK stack to ensure application performance and reliability}
      \resumeItem{Collaborated closely with development teams to ensure seamless integration of continuous delivery practices and faster feedback loops.}
    \resumeItemListEnd{}
